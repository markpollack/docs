...
Version `0.12.0` adds session/list, session/close, session/resume, elicitation, session/fork, and session/set_config_option. See the [API Reference](/docs/acp-java-sdk/reference/java#installation) for installation.
