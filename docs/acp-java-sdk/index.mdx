...
For the latest features (session/list, session/close, session/resume), use the `0.12.0-SNAPSHOT` — see the [API Reference](/docs/acp-java-sdk/reference/java#installation) for snapshot repository setup.
