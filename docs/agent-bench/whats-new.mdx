...
description: "Release and development-line notes for Agent Bench"
---

## 0.6.0 development line (unreleased)
...
- Aligns the development dependency floors with Jackson 2.21.6, Jackson 3.1.6, Agent Judge 0.14.0,
  and Agent Client 0.26.0.

0.6.0 is not yet a public release. The latest public release remains 0.5.0.
