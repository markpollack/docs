...
```java
import io.github.markpollack.claude.ClaudeAgentSessionRegistry;
import io.github.markpollack.model.AgentSession;
import io.github.markpollack.model.AgentResponse;
