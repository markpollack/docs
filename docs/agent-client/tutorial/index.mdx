...
<Card title="Tutorial Source Code" icon="github" href="https://github.com/spring-ai-community/agent-client-tutorial">
  Clone the repo and follow along: `git clone https://github.com/spring-ai-community/agent-client-tutorial.git`
</Card>
