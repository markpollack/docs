...
description: "Record and persist a first Agent Journal run with journal-core 1.6.0"
---
...
Version 1.6.0 does not enforce path containment for those values, so do not pass untrusted path fragments or separators.
</Warning>
