...
description: "Record and persist a first Agent Journal run with journal-core 1.10.1"
---
...
Version 1.10.1 does not enforce path containment for those values, so do not pass untrusted path fragments or separators.
</Warning>
