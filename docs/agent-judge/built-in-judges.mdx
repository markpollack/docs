...
description: "Deterministic, execution, file, LLM, RAG, and requirements judges in Agent Judge 0.17"
---
...
The executable starting point is [tutorial module 01](https://github.com/markpollack/agent-judge-tutorial/tree/106ca35a74ebdd9995329cb0bde63d66a9e7e8ed/module-01-oracle-boundary).
...
[Tutorial module 03](https://github.com/markpollack/agent-judge-tutorial/tree/106ca35a74ebdd9995329cb0bde63d66a9e7e8ed/module-03-coverage-evidence) runs all three cases.
...
[Tutorial module 02](https://github.com/markpollack/agent-judge-tutorial/tree/106ca35a74ebdd9995329cb0bde63d66a9e7e8ed/module-02-build-and-tests) executes the Maven build path.
...
[Tutorial module 07](https://github.com/markpollack/agent-judge-tutorial/tree/106ca35a74ebdd9995329cb0bde63d66a9e7e8ed/module-07-model-backed-judge) runs that complete path with no credentials.
...
The credential-free bridge samples are [Koog module 10](https://github.com/markpollack/agent-judge-tutorial/tree/106ca35a74ebdd9995329cb0bde63d66a9e7e8ed/module-10-koog-evaluation) and [LangChain4j module 11](https://github.com/markpollack/agent-judge-tutorial/tree/106ca35a74ebdd9995329cb0bde63d66a9e7e8ed/module-11-langchain4j-evaluation).

## Requirements judges

<Info>New in 0.16.0. Artifact: `agent-judge-ai-core`.</Info>

`EarsJudge` and `Rfc2119Judge` read written acceptance criteria and architectural constraints back
against the implementation. See [Requirements judges](/docs/agent-judge/requirements-judges) for the
roster and strict rollup, a BOM import, runnable examples, and the case study.
