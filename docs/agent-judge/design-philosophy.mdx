...
`ABSTAIN`, `NOT_APPLICABLE`, and `ERROR` cannot carry a score, and all three require non-blank reasoning.
`ERROR` cannot carry a label.
...
The separate [Agent Judge Tutorial](https://github.com/markpollack/agent-judge-tutorial/tree/106ca35a74ebdd9995329cb0bde63d66a9e7e8ed) owns canonical examples.
Its eleven fundamentals modules compile and run without credentials, so documentation can link to maintained source instead of carrying divergent sample programs.
