...
Continue with the [conference talk](https://www.youtube.com/live/sTcx0EvILr4?t=3702) or the [runnable case study](https://github.com/markpollack/agent-judge-tutorial/tree/main/case-studies/spec-driven-petclinic).
