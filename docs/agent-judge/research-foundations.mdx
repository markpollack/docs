...
| Preserve uncertainty | Keep disagreement, lack of applicability, and evaluator failure distinct from a negative finding. | `PASS`, `FAIL`, `ABSTAIN`, `NOT_APPLICABLE`, and `ERROR` outcomes with structured aggregation evidence |
