...
See [Writing Custom Judges — ModelBackedJudge](/docs/agent-judge/custom-judge#step-4-build-an-ai-judge-with-modelbackedjudge) for details.
</Note>
...
Every step in this tutorial has a corresponding runnable module in the [agent-judge-tutorial](https://github.com/markpollack/agent-judge-tutorial) repository.
Clone it and run any module with `./mvnw exec:java -pl module-NN-name`.
