...
description: "Eight complete, runnable examples — validated with real LLM calls against GPT-4.1"
---

Every example below is a real integration test from [workflow-dsl-examples](https://github.com/markpollack/workflow-dsl-examples). All eight pass against GPT-4.1 with temperature 0.3.
