...
| `A2AStep` (planned) | Remote agent via Agent Communication Protocol | Minutes |
...
- **Portable runtimes** — the IR decouples workflow definition from execution. Additional runtimes (JDBC checkpointing, durable execution) can be added without changing workflow code
