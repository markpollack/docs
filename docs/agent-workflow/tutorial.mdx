...
[View source: SequentialIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/SequentialIT.java)
...
[View source: BranchIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/BranchIT.java)
...
[View source: OnErrorIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/OnErrorIT.java)
...
[View source: LoopIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/LoopIT.java)
...
[View source: ParallelIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/ParallelIT.java)
...
[View source: DecisionIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/DecisionIT.java)
...
[View source: GateIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/GateIT.java)
...
[View source: SupervisorIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/SupervisorIT.java)

---

## Runnable Code

Every step in this tutorial has a corresponding integration test in the [workflow-dsl-examples](https://github.com/markpollack/workflow-dsl-examples) repository. Clone it and run all examples:
...
```bash
./mvnw verify -Dtest=BranchIT
```

The repository also includes examples for [context propagation](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/ContextWritesIT.java), [step parameterization](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/ParameterizationIT.java), [type checking](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/TypeCheckingIT.java), [annotation model](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/AnnotationModelIT.java), and [crash recovery](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/ours/CrashRecoveryIT.java) (no API key needed).
