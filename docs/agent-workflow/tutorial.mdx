...
[View source: SequentialIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/SequentialIT.java)
...
[View source: BranchIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/BranchIT.java)
...
[View source: OnErrorIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/OnErrorIT.java)
...
[View source: LoopIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/LoopIT.java)
...
[View source: ParallelIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/ParallelIT.java)
...
[View source: DecisionIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/DecisionIT.java)
...
[View source: GateIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/GateIT.java)
...
[View source: SupervisorIT.java](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/SupervisorIT.java)
...
The repository also includes examples for [context propagation](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/ContextWritesIT.java), [step parameterization](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/ParameterizationIT.java), [type checking](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/TypeCheckingIT.java), [annotation model](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/AnnotationModelIT.java), and [crash recovery](https://github.com/markpollack/workflow-dsl-examples/blob/main/src/test/java/io/github/markpollack/workflow/examples/dsl/CrashRecoveryIT.java) (no API key needed).
