...
This is a repository and release-coordinate cleanup, not a deprecation of the
Spring AI Community organization. Projects that remain under
`spring-ai-community` continue to use their existing repositories and coordinates.
