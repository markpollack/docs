...
<CardGroup cols={2}>
  ...
  >
    Skills vs flat knowledge bases — 7 variants on Spring PetClinic. Skills+preanalysis cuts expected steps by roughly a quarter to a third with no quality loss (absolute step counts corrected 2026-08-27 — see the experiment page).
  </Card>
  <Card
