...
We don't just measure whether agents succeed — we measure *how* they behave on the way to success or failure, using Markov chain analysis of tool-call traces.
...
<CardGroup cols={2}>
  <Card
    title="Code Coverage v3"
    icon="check-circle"
    href="/experiments/code-coverage-v3"
  >
  ...
  >
    Skills vs flat knowledge bases — 7 variants on Spring PetClinic. **The efficiency result is withdrawn** — reanalysis found the correction it rested on does not hold, and no replacement figure is offered. Kept as a record of method, not of result.
  </Card>
  <Card
