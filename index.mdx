...
The whole suite ships as one coordinated train, pinned by the [AgentWorks BOM](/projects/agentworks-bom) — currently **1.12.0**, spanning a dozen libraries all shipped within the last month.
