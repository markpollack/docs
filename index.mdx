...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '1rem'}}>
  <div style={{borderLeft: '3px solid #ffd740', paddingLeft: '0.75rem'}}>
    ...
    <div style={{fontSize: '0.8rem', color: '#666', margin: '0.25rem 0'}}>7 new protocol methods: session/list, close, resume (stable) + elicitation, fork, config options (unstable). New <code>@UnstableAcpApi</code> stability marker.</div>
