...
Tools and experiments for building agents that work — and understanding why they work. Capture every tool call, score the output, analyze the behavior. When something goes wrong, see *where* and *why*. Fix it. Measure whether the fix worked.
