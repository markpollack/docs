...
Agentic software gets built inside explicit workflows, recorded as it runs, and scored against stated criteria. This lab publishes the methodology, the libraries that run it, and the experiments that test what improves agent behavior.
