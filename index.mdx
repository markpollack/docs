...
The whole suite ships as one coordinated train, pinned by the [AgentWorks BOM](/projects/agentworks-bom) — currently **1.14.0**, spanning a dozen libraries all shipped within the last month.

<div style={{display: 'flex', flexWrap: 'wrap', gap: '0.5rem', margin: '1.25rem 0'}}>
  <a href="/projects/agentworks-bom" style={{padding: '0.3rem 0.75rem', borderRadius: '999px', border: '1px solid rgba(255,215,64,0.35)', background: 'rgba(255,215,64,0.08)', fontSize: '0.8rem', textDecoration: 'none', color: '#e8e8e8'}}>agentworks-bom <b style={{fontFamily: 'Geist Mono, monospace', color: '#ffd740'}}>1.14.0</b></a>
