...
<Steps>
  ...
  <Step title="Grow">
    The [Improvement Flywheel](/methodology/improvement-flywheel) drives iterative refinement: **RUN → MEASURE → DIAGNOSE → INTERVENE → VERIFY**. Each cycle identifies a measurable loss signal, diagnoses its cause through [behavioral analysis](/methodology/markov-fingerprinting) and [jury evaluation](/methodology/four-tier-jury), applies a targeted intervention, and verifies the improvement without regressions. Findings feed back into the Define phase — new knowledge, tighter prompts, or deterministic replacements for exploratory steps.
  </Step>
</Steps>
