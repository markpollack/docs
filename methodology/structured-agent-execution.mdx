...
- **Fewest expected steps** to completion of any v1 arm *(the figure previously given here, "70 expected steps vs 100+", is withdrawn — see the [v1 experiment page](/experiments/code-coverage-v1) correction of 2026-08-27; the ordering holds, the absolute count did not reproduce)*
...
|-----------|---------|------|
| Pre-analysis tools | [Agent Tools](/projects/agent-tools) and [Agent Skills](/projects/agent-skills) | Deterministic parsing |
...
Steps 1-3 are design decisions recorded in the project's `DESIGN.md`; [Forge](/methodology/forge) is the methodology that gets you to that document and holds you to it.

## Related

<CardGroup cols={2}>
  <Card title="Forge" icon="hammer" href="/methodology/forge">
    The methodology that produces the design an SAE template implements
  </Card>
