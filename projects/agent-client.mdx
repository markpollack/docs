...
**Version 0.18.0** — [Maven Central](https://central.sonatype.com/search?q=g:io.github.markpollack+a:agent-client-core)
...
<CardGroup cols={2}>
  ...
  <Card title="Source Code" icon="github" href="https://github.com/markpollack/agent-client">
    GitHub repository
  </Card>
</CardGroup>
