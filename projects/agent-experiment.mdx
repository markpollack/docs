...
**Current release: 0.6.0** · Java 21 · three modules · 544 tests
...
|--------|-------------|------------------|
| `experiment-core` | Datasets, workspace provisioning, runner, journals, comparison, results, storage | Agent Judge 0.14.0, Agent Journal 1.7.0, Jackson |
| `experiment-claude` | Claude SDK invoker, plan generator, semantic judge | Claude Code SDK 1.4.0 |
| `experiment-workflow` | Typed workflow invokers with journal and cost adaptation | Agent Workflow 0.10.0, Agent Client 0.26.0 |
...
Standalone consumers resolve Agent Journal/Capture 1.7.0, Jackson 2.21.6, and Jackson 3.1.6 without
