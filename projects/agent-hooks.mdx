...
Adapters (Spring AI and Claude Agent SDK) wire the core into their runtime's tool-call lifecycle.
...
```java
// This provider works on both Spring AI and Claude CLI
...
<CardGroup cols={2}>
  <Card title="Source Code" icon="github" href="https://github.com/markpollack/agent-hooks">
    Core API, Spring AI adapter, and Claude adapter
  </Card>
