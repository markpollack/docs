...
**Current release: 0.6.4.** Built on Spring AI 2.0.0 GA and Spring Boot 4.0.7; the prior 0.6.3 release migrated onto the new Claude Agent SDK. The hook-API architecture — core plus the Spring AI, Claude, and Gemini adapters — is unchanged since 0.6.0.
