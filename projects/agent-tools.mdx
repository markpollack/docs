...
A Spring AI library that reimplements Claude Code-inspired capabilities as Java-based tools. This is the foundational toolkit for building AI agents in Java/Spring applications — the tools that [Loopy](/projects/loopy) and [Agent Workflow](/projects/agent-workflow) use under the hood.
...
- **[Agent Workflow](/projects/agent-workflow)** — provides tools via the `workflow-tools` module
