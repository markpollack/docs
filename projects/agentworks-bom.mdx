...
| `agent-client-core` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-model` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-claude` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-gemini` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-launcher` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-qwen-code` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-claude` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-gemini` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-amp` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-codex` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-amazon-q` | 0.24.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-qwen-code` | 0.24.0 | [Agent Client](/projects/agent-client) |
