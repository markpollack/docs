...
<Note>
The BOM tracks a verified compatible set, so it can trail the newest individual release.
1.16.0 pins Agent Client **0.28.0** and Agent Journal **1.7.0**; the current standalone releases are
Agent Client 0.29.0 and Agent Journal 1.8.0. Import the BOM for a set that has been tested together,
or declare those two coordinates explicitly to move ahead of it.
</Note>
...
|----------|---------|---------|
| `agent-hooks-core` | 0.7.0 | [Agent Hooks](/projects/agent-hooks) |
| `agent-hooks-spring` | 0.7.0 | [Agent Hooks](/projects/agent-hooks) |
| `agent-hooks-claude` | 0.7.0 | [Agent Hooks](/projects/agent-hooks) |
| `agent-hooks-gemini` | 0.7.0 | [Agent Hooks](/projects/agent-hooks) |
| `journal-core` | 1.7.0 | [Agent Journal](/projects/agent-journal) |
| `claude-code-capture` | 1.7.0 | [Agent Journal](/projects/agent-journal) |
| `gemini-cli-capture` | 1.7.0 | [Agent Journal](/projects/agent-journal) |
...
| `experiment-core` | 0.6.0 | [Agent Experiment](/projects/agent-experiment) |
| `experiment-claude` | 0.6.0 | [Agent Experiment](/projects/agent-experiment) |
| `memory-core` | 0.4.0 | [Agent Memory](/projects/agent-memory) |
| `memory-advisor` | 0.4.0 | [Agent Memory](/projects/agent-memory) |
| `claude-code-sdk` | 1.5.0 | [Claude Agent SDK](/projects/claude-agent-sdk) |
| `agent-bench-core` | 0.6.0 | [Agent Bench](/projects/agent-bench) |
| `agent-bench-agents` | 0.6.0 | [Agent Bench](/projects/agent-bench) |
| `agent-judge-core` | 0.15.0 | [Agent Judge](/projects/agent-judge) |
| `agent-judge-llm` | 0.15.0 | [Agent Judge](/projects/agent-judge) |
| `agent-judge-exec` | 0.15.0 | [Agent Judge](/projects/agent-judge) |
| `agent-judge-file` | 0.15.0 | [Agent Judge](/projects/agent-judge) |
| `agent-sandbox-core` | 0.10.0 | [Agent Sandbox](/projects/agent-sandbox) |
| `agent-sandbox-docker` | 0.10.0 | [Agent Sandbox](/projects/agent-sandbox) |
| `agent-sandbox-e2b` | 0.10.0 | [Agent Sandbox](/projects/agent-sandbox) |
| `agent-client-core` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-model` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-claude` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-gemini` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-launcher` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-qwen-code` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-claude` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-gemini` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-amp` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-codex` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-amazon-q` | 0.28.0 | [Agent Client](/projects/agent-client) |
| `agent-starter-qwen-code` | 0.28.0 | [Agent Client](/projects/agent-client) |

### Agent Client Protocol (com.agentclientprotocol)

| Artifact | Version | Project |
|----------|---------|---------|
| `acp-annotations` | 0.15.0 | [ACP Java SDK](/projects/acp-java-sdk) |
| `acp-core` | 0.15.0 | [ACP Java SDK](/projects/acp-java-sdk) |
| `acp-agent-support` | 0.15.0 | [ACP Java SDK](/projects/acp-java-sdk) |
| `acp-test` | 0.15.0 | [ACP Java SDK](/projects/acp-java-sdk) |
| `acp-websocket-jetty` | 0.15.0 | [ACP Java SDK](/projects/acp-java-sdk) |
