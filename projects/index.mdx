...
<CardGroup cols={2}>
  ...
  >
    Spring-native DSL for multi-step agentic pipelines — compose steps with branching, loops, gates, and parallel execution. Compiles to a graph IR with portable runtimes.
  </Card>
  <Card
    title="Agent Client"
    icon="robot"
